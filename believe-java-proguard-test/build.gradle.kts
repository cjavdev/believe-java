...
dependencies {
    testImplementation(project(":believe-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../believe-java-core/src/main/resources/META-INF/proguard/believe-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("dev.cjav.believe.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../believe-java-core/src/main/resources/META-INF/proguard/believe-java-core.pro",

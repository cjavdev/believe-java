...
import dev.cjav.believe.core.http.HttpRequestBody
import dev.cjav.believe.core.http.HttpResponse
import dev.cjav.believe.core.http.ProxyAuthenticator
import dev.cjav.believe.errors.BelieveIoException
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(BelieveIoException("Request failed", e))
                }
            }
        )

...
[![Maven Central](https://img.shields.io/maven-central/v/dev.cjav.believe/believe-java)](https://central.sonatype.com/artifact/dev.cjav.believe/believe-java/0.8.0)
[![javadoc](https://javadoc.io/badge2/dev.cjav.believe/believe-java/0.8.0/javadoc.svg)](https://javadoc.io/doc/dev.cjav.believe/believe-java/0.8.0)
...
Javadocs are available on [javadoc.io](https://javadoc.io/doc/dev.cjav.believe/believe-java/0.8.0).
...
```kotlin
implementation("dev.cjav.believe:believe-java:0.8.0")
```

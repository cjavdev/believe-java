...
[![Maven Central](https://img.shields.io/maven-central/v/dev.cjav.believe/believe-java)](https://central.sonatype.com/artifact/dev.cjav.believe/believe-java/0.8.4)
[![javadoc](https://javadoc.io/badge2/dev.cjav.believe/believe-java/0.8.4/javadoc.svg)](https://javadoc.io/doc/dev.cjav.believe/believe-java/0.8.3)
...
Javadocs are available on [javadoc.io](https://javadoc.io/doc/dev.cjav.believe/believe-java/0.8.4).
...
```kotlin
implementation("dev.cjav.believe:believe-java:0.8.4")
```

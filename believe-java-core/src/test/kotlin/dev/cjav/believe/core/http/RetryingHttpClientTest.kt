...
package dev.cjav.believe.core.http
...
import dev.cjav.believe.client.okhttp.OkHttpClient
import dev.cjav.believe.core.RequestOptions
import dev.cjav.believe.core.Sleeper
import dev.cjav.believe.errors.BelieveRetryableException
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            BelieveRetryableException("Simulated retryable failure")
                        )
                        return future
                    }

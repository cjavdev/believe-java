...
internal class QuoteServiceAsyncTest {
    ...
    fun create() {
      ...
      val quoteFuture = quoteServiceAsync.create(QuoteCreateParams.builder()
    ...
    fun update() {
      ...
      val quoteFuture = quoteServiceAsync.update(QuoteUpdateParams.builder()
          .quoteId("quote_id")
    ...
    fun getRandom() {
      ...
      val quoteFuture = quoteServiceAsync.getRandom(QuoteGetRandomParams.builder()
          .characterId("character_id")
          .inspirational(true)
          .theme(QuoteTheme.BELIEF)
          .build())

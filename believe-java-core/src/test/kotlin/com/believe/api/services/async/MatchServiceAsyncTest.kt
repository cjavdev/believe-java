...
internal class MatchServiceAsyncTest {
    ...
    fun create() {
      ...
      val matchFuture = matchServiceAsync.create(MatchCreateParams.builder()
    ...
    fun update() {
      ...
      val matchFuture = matchServiceAsync.update(MatchUpdateParams.builder()
          .matchId("match_id")
          .attendance(0L)
          .awayScore(0L)
    ...
    fun streamLive() {
      ...
      val future = matchServiceAsync.streamLive(MatchStreamLiveParams.builder()
          .awayTeam("away_team")
          .excitementLevel(1L)
          .homeTeam("home_team")
          .speed(0.1)

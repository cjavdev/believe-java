...
internal class MatchCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.lessonLearned()).contains("It's not about the wins and losses, it's about helping these young fellas be the best versions of themselves.")
      assertThat(body.possessionPercentage()).contains(50.0)
      assertThat(body.result()).contains(MatchResult.PENDING)
      assertThat(body.tedHalftimeSpeech()).contains("You know what the happiest animal on Earth is? It's a goldfish. You know why? It's got a 10-second memory.")
      assertThat(body.ticketRevenueGbp()).contains(MatchCreateParams.TicketRevenueGbp.ofString("735000.00"))

...
internal class EpisodeCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.biscuitsWithBossMoment()).contains("Ted and Rebecca have an honest conversation about trust.")
      assertThat(body.memorableMoments().getOrNull()).containsExactly("First Diamond Dogs meeting", "The famous dart scene with Rupert", "Be curious, not judgmental speech")
      assertThat(body.usViewersMillions()).contains(1.42)
      assertThat(body.viewerRating()).contains(9.1)
    }

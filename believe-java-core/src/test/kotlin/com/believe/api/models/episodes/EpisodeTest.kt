...
internal class EpisodeTest {
    ...
    fun create() {
      ...
      assertThat(episode.biscuitsWithBossMoment()).contains("Ted brings Rebecca homemade biscuits for the first time.")
      assertThat(episode.memorableMoments().getOrNull()).containsExactly("Ted's first press conference", "The BELIEVE sign goes up", "Ted tastes his first 'garbage water' (English tea)")
      assertThat(episode.usViewersMillions()).contains(1.25)
      assertThat(episode.viewerRating()).contains(8.7)
    }

...
internal class EquipmentManagerTest {
    ...
    fun create() {
      ...
      assertThat(equipmentManager.memberType()).contains(EquipmentManager.MemberType.EQUIPMENT_MANAGER)
      assertThat(equipmentManager.responsibilities().getOrNull()).containsExactly("Kit preparation", "Equipment maintenance")
    }

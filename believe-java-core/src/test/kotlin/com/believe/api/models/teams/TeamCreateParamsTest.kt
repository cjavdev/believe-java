...
internal class TeamCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.values()).isEqualTo(TeamValues.builder()
          ...
          .teamMotto("Forever Blowing Bubbles")
          .build())
      assertThat(body.annualBudgetGbp()).contains(TeamCreateParams.AnnualBudgetGbp.ofString("150000000.00"))
      ...
      assertThat(body.stadiumLocation()).contains(GeoLocation.builder()
          .latitude(51.5387)
          .longitude(-0.0166)
          .build())

...
internal class CharacterTest {
    ...
    fun create() {
      ...
      assertThat(character.growthArcs().getOrNull()).containsExactly(GrowthArc.builder()
          .breakthrough("Showing vulnerability about his marriage")
          .challenge("Earning respect despite inexperience")
          .endingPoint("Accepted by the team despite relegation")
          .season(1L)
      ...
      assertThat(character.profileImageUrl()).contains("https://afcrichmond.com/images/ted-lasso.jpg")
      assertThat(character.salaryGbp()).contains("150000.00")
      assertThat(character.signatureQuotes().getOrNull()).containsExactly("I believe in believe.", "Be curious, not judgmental.")

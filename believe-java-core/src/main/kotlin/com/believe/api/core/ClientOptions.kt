...
import com.believe.api.core.PhantomReachableExecutorService
...
class ClientOptions private constructor(
     ...
     *
     * Use the one published in `believe-java-client-okhttp` or implement your
     * own.
     *
                  ...
                  object : ThreadFactory {
                      ...
                      override fun newThread(runnable: Runnable): Thread =
                          threadFactory.newThread(runnable).also {
                              it.name = "believe-stream-handler-thread-${count.getAndIncrement()}"
                          }
                  }
              )
          )

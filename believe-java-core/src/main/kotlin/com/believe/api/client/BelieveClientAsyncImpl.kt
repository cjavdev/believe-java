...
class BelieveClientAsyncImpl(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BelieveClientAsync = BelieveClientAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun getWelcome(params: ClientGetWelcomeParams, requestOptions: RequestOptions): CompletableFuture<ClientGetWelcomeResponse> =
        // get /
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BelieveClientAsync.WithRawResponse = BelieveClientAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun getWelcome(params: ClientGetWelcomeParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ClientGetWelcomeResponse>> {

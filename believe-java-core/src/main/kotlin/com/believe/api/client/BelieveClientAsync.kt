...
interface BelieveClientAsync {
    ...
    fun getWelcome(): CompletableFuture<ClientGetWelcomeResponse> = getWelcome(ClientGetWelcomeParams.none())

    /** @see getWelcome */
    fun getWelcome(params: ClientGetWelcomeParams = ClientGetWelcomeParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ClientGetWelcomeResponse>

    /** @see getWelcome */
    fun getWelcome(params: ClientGetWelcomeParams = ClientGetWelcomeParams.none()): CompletableFuture<ClientGetWelcomeResponse> =
        getWelcome(
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): BelieveClientAsync.WithRawResponse
        ...
        fun getWelcome(): CompletableFuture<HttpResponseFor<ClientGetWelcomeResponse>> = getWelcome(ClientGetWelcomeParams.none())

        /** @see getWelcome */
        fun getWelcome(params: ClientGetWelcomeParams = ClientGetWelcomeParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ClientGetWelcomeResponse>>

        /** @see getWelcome */
        fun getWelcome(params: ClientGetWelcomeParams = ClientGetWelcomeParams.none()): CompletableFuture<HttpResponseFor<ClientGetWelcomeResponse>> =
            getWelcome(
              params, RequestOptions.none()
            )

        /** @see getWelcome */
        fun getWelcome(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ClientGetWelcomeResponse>> =
            getWelcome(
              ClientGetWelcomeParams.none(), requestOptions
            )
    }

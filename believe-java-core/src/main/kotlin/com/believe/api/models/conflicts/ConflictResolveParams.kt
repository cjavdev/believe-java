...
class ConflictResolveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun attemptsMade(attemptsMade: Optional<List<String>>) = attemptsMade(attemptsMade.getOrNull())
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (conflictType.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (partiesInvolved.asKnown().getOrNull()?.size ?: 0) + (attemptsMade.asKnown().getOrNull()?.size ?: 0)

...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = teamMemberListResponse.accept(new TeamMemberListResponse.Visitor<Optional<String>>() {
     *     @Override
    ...
    companion object {
        ...
        /** Full player model with ID. */
        @JvmStatic fun ofPlayer(player: Player) = TeamMemberListResponse(player = player)

        /** Full coach model with ID. */
        @JvmStatic fun ofCoach(coach: Coach) = TeamMemberListResponse(coach = coach)

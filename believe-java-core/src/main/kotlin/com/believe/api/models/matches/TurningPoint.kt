...
class TurningPoint @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
     ...
     */
    fun characterInvolved(): Optional<String> = characterInvolved.getOptional("character_involved")
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.characterInvolved] with `characterInvolved.orElse(null)`. */
        fun characterInvolved(characterInvolved: Optional<String>) = characterInvolved(characterInvolved.getOrNull())
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (description.asKnown().isPresent) 1 else 0) + (if (emotionalImpact.asKnown().isPresent) 1 else 0) + (if (minute.asKnown().isPresent) 1 else 0) + (if (characterInvolved.asKnown().isPresent) 1 else 0)

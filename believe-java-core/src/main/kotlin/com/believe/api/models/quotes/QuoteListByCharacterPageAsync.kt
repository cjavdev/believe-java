...
class QuoteListByCharacterPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<QuoteListByCharacterPageAsync> = service.listByCharacter(nextPageParams())

    fun autoPager(): AutoPagerAsync<Quote> =
        AutoPagerAsync.from(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is QuoteListByCharacterPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "QuoteListByCharacterPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}

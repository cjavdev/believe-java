...
class CharacterListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<CharacterListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<Character> =
        AutoPagerAsync.from(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CharacterListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "CharacterListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}

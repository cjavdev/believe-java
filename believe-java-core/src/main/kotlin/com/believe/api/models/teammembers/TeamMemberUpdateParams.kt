...
class TeamMemberUpdateParams private constructor(
    ...
    class Updates private constructor(
        ...
        fun medicalStaffUpdate(): Optional<MedicalStaffUpdate> = Optional.ofNullable(medicalStaffUpdate)

        /** Update model for equipment managers. */
        fun equipmentManagerUpdate(): Optional<EquipmentManagerUpdate> = Optional.ofNullable(equipmentManagerUpdate)
        ...
        class PlayerUpdate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun jerseyNumber(jerseyNumber: Optional<Long>) = jerseyNumber(jerseyNumber.getOrNull())
                ...
                fun yearsWithTeam(yearsWithTeam: Optional<Long>) = yearsWithTeam(yearsWithTeam.getOrNull())
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (assists.asKnown().isPresent) 1 else 0) + (if (goalsScored.asKnown().isPresent) 1 else 0) + (if (isCaptain.asKnown().isPresent) 1 else 0) + (if (jerseyNumber.asKnown().isPresent) 1 else 0) + (position.asKnown().getOrNull()?.validity() ?: 0) + (if (teamId.asKnown().isPresent) 1 else 0) + (if (yearsWithTeam.asKnown().isPresent) 1 else 0)
        ...
        class CoachUpdate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun certifications(certifications: Optional<List<String>>) = certifications(certifications.getOrNull())
                ...
                fun specialty(specialty: Optional<CoachSpecialty>) = specialty(specialty.getOrNull())
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (certifications.asKnown().getOrNull()?.size ?: 0) + (specialty.asKnown().getOrNull()?.validity() ?: 0) + (if (teamId.asKnown().isPresent) 1 else 0) + (if (winRate.asKnown().isPresent) 1 else 0) + (if (yearsWithTeam.asKnown().isPresent) 1 else 0)
        ...
        class MedicalStaffUpdate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun qualifications(qualifications: Optional<List<String>>) = qualifications(qualifications.getOrNull())
                ...
                /** Alias for calling [Builder.specialty] with `specialty.orElse(null)`. */
                fun specialty(specialty: Optional<MedicalSpecialty>) = specialty(specialty.getOrNull())
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (licenseNumber.asKnown().isPresent) 1 else 0) + (qualifications.asKnown().getOrNull()?.size ?: 0) + (specialty.asKnown().getOrNull()?.validity() ?: 0) + (if (teamId.asKnown().isPresent) 1 else 0) + (if (yearsWithTeam.asKnown().isPresent) 1 else 0)
        ...
        class EquipmentManagerUpdate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun isHeadKitman(isHeadKitman: Optional<Boolean>) = isHeadKitman(isHeadKitman.getOrNull())
                ...
                /** Alias for calling [Builder.responsibilities] with `responsibilities.orElse(null)`. */
                fun responsibilities(responsibilities: Optional<List<String>>) = responsibilities(responsibilities.getOrNull())
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (isHeadKitman.asKnown().isPresent) 1 else 0) + (responsibilities.asKnown().getOrNull()?.size ?: 0) + (if (teamId.asKnown().isPresent) 1 else 0) + (if (yearsWithTeam.asKnown().isPresent) 1 else 0)

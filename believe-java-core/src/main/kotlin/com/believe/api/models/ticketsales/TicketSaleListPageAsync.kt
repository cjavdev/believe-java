...
class TicketSaleListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<TicketSaleListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<TicketSale> =
        AutoPagerAsync.from(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TicketSaleListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "TicketSaleListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}

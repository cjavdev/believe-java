...
class QuoteListByThemePageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<QuoteListByThemePageAsync> = service.listByTheme(nextPageParams())
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is QuoteListByThemePageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "QuoteListByThemePageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}

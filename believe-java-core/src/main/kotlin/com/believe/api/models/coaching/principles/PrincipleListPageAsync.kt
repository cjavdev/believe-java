...
class PrincipleListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<PrincipleListPageAsync> = service.list(nextPageParams())
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PrincipleListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "PrincipleListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}

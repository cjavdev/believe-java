...
class BiscuitServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BiscuitServiceAsync = BiscuitServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun retrieve(params: BiscuitRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Biscuit> =
        // get /biscuits/{biscuit_id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun list(params: BiscuitListParams, requestOptions: RequestOptions): CompletableFuture<BiscuitListPageAsync> =
        // get /biscuits
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun getFresh(params: BiscuitGetFreshParams, requestOptions: RequestOptions): CompletableFuture<Biscuit> =
        // get /biscuits/fresh
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BiscuitServiceAsync.WithRawResponse = BiscuitServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val retrieveHandler: Handler<Biscuit> = jsonHandler<Biscuit>(clientOptions.jsonMapper)

        override fun retrieve(params: BiscuitRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Biscuit>> {
        ...
        override fun list(params: BiscuitListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BiscuitListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun getFresh(params: BiscuitGetFreshParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Biscuit>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())

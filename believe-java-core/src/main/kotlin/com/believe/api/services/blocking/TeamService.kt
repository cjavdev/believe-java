...
interface TeamService {
    ...
    fun create(params: TeamCreateParams): Team =
        create(
    ...
    fun retrieve(teamId: String): Team =
        retrieve(
    ...
    /** @see retrieve */
    fun retrieve(params: TeamRetrieveParams): Team =
        retrieve(
          params, RequestOptions.none()
        )
    ...
    /** @see update */
    fun update(params: TeamUpdateParams): Team =
        update(
          params, RequestOptions.none()
        )
    ...
    /** @see delete */
    fun delete(params: TeamDeleteParams) =
        delete(
          params, RequestOptions.none()
        )
    ...
    /** @see getCulture */
    fun getCulture(teamId: String, params: TeamGetCultureParams = TeamGetCultureParams.none()): TeamGetCultureResponse =
        getCulture(
          teamId,
          params,
          RequestOptions.none(),
    ...
    fun getRivals(teamId: String): List<Team> =
        getRivals(
    ...
    /** @see getRivals */
    fun getRivals(teamId: String, params: TeamGetRivalsParams = TeamGetRivalsParams.none()): List<Team> =
        getRivals(
          teamId,
          params,
          RequestOptions.none(),
    ...
    fun listLogos(teamId: String): List<FileUpload> =
        listLogos(
    ...
    /** @see listLogos */
    fun listLogos(teamId: String, params: TeamListLogosParams = TeamListLogosParams.none()): List<FileUpload> =
        listLogos(
          teamId,
          params,
          RequestOptions.none(),
    ...
    interface WithRawResponse {
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(teamId: String, params: TeamRetrieveParams = TeamRetrieveParams.none()): HttpResponseFor<Team> =
            retrieve(
              teamId,
              params,
              RequestOptions.none(),
        ...
        @MustBeClosed
        fun update(teamId: String): HttpResponseFor<Team> =
            update(
              teamId, TeamUpdateParams.none()
            )
        ...
        /** @see update */
        @MustBeClosed
        fun update(teamId: String, params: TeamUpdateParams = TeamUpdateParams.none()): HttpResponseFor<Team> =
            update(
              teamId,
              params,
              RequestOptions.none(),
        ...
        @MustBeClosed
        fun list(): HttpResponseFor<TeamListPage> = list(TeamListParams.none())
        ...
        @MustBeClosed
        fun delete(teamId: String): HttpResponse =
            delete(
              teamId, TeamDeleteParams.none()
            )
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(teamId: String, params: TeamDeleteParams = TeamDeleteParams.none()): HttpResponse =
            delete(
              teamId,
              params,
              RequestOptions.none(),
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(params: TeamDeleteParams): HttpResponse =
            delete(
              params, RequestOptions.none()
            )
        ...
        /** @see getCulture */
        @MustBeClosed
        fun getCulture(teamId: String, params: TeamGetCultureParams = TeamGetCultureParams.none()): HttpResponseFor<TeamGetCultureResponse> =
            getCulture(
              teamId,
              params,
              RequestOptions.none(),
        ...
        /** @see getRivals */
        @MustBeClosed
        fun getRivals(teamId: String, params: TeamGetRivalsParams = TeamGetRivalsParams.none()): HttpResponseFor<List<Team>> =
            getRivals(
              teamId,
              params,
              RequestOptions.none(),
        ...
        /** @see listLogos */
        @MustBeClosed
        fun listLogos(teamId: String, params: TeamListLogosParams = TeamListLogosParams.none()): HttpResponseFor<List<FileUpload>> =
            listLogos(
              teamId,
              params,
              RequestOptions.none(),

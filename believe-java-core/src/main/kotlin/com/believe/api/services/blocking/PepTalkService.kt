...
interface PepTalkService {
    ...
    /** @see retrieve */
    fun retrieve(params: PepTalkRetrieveParams = PepTalkRetrieveParams.none()): PepTalkRetrieveResponse =
        retrieve(
    ...
    interface WithRawResponse {
        ...
        @MustBeClosed
        fun retrieve(): HttpResponseFor<PepTalkRetrieveResponse> = retrieve(PepTalkRetrieveParams.none())
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: PepTalkRetrieveParams = PepTalkRetrieveParams.none()): HttpResponseFor<PepTalkRetrieveResponse> =
            retrieve(
              params, RequestOptions.none()
            )

...
class TicketSaleServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TicketSaleServiceAsync = TicketSaleServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: TicketSaleCreateParams, requestOptions: RequestOptions): CompletableFuture<TicketSale> =
        // post /ticket-sales
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: TicketSaleRetrieveParams, requestOptions: RequestOptions): CompletableFuture<TicketSale> =
        // get /ticket-sales/{ticket_sale_id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: TicketSaleUpdateParams, requestOptions: RequestOptions): CompletableFuture<TicketSale> =
        // patch /ticket-sales/{ticket_sale_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: TicketSaleListParams, requestOptions: RequestOptions): CompletableFuture<TicketSaleListPageAsync> =
        // get /ticket-sales
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: TicketSaleDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TicketSaleServiceAsync.WithRawResponse = TicketSaleServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<TicketSale> = jsonHandler<TicketSale>(clientOptions.jsonMapper)

        override fun create(params: TicketSaleCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<TicketSale>> {
        ...
        override fun retrieve(params: TicketSaleRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<TicketSale>> {
        ...
        override fun update(params: TicketSaleUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<TicketSale>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("ticketSaleId", params.ticketSaleId().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun list(params: TicketSaleListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<TicketSaleListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("ticket-sales")
        ...
        override fun delete(params: TicketSaleDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("ticketSaleId", params.ticketSaleId().getOrNull())
          val request = HttpRequest.builder()

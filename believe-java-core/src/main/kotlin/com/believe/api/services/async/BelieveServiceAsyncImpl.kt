...
class BelieveServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BelieveServiceAsync = BelieveServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun submit(params: BelieveSubmitParams, requestOptions: RequestOptions): CompletableFuture<BelieveSubmitResponse> =
        // post /believe
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BelieveServiceAsync.WithRawResponse = BelieveServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val submitHandler: Handler<BelieveSubmitResponse> = jsonHandler<BelieveSubmitResponse>(clientOptions.jsonMapper)

        override fun submit(params: BelieveSubmitParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BelieveSubmitResponse>> {

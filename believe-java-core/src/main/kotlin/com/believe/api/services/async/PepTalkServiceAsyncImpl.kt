...
class PepTalkServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PepTalkServiceAsync = PepTalkServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun retrieve(params: PepTalkRetrieveParams, requestOptions: RequestOptions): CompletableFuture<PepTalkRetrieveResponse> =
        // get /pep-talk
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PepTalkServiceAsync.WithRawResponse = PepTalkServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val retrieveHandler: Handler<PepTalkRetrieveResponse> = jsonHandler<PepTalkRetrieveResponse>(clientOptions.jsonMapper)

        override fun retrieve(params: PepTalkRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PepTalkRetrieveResponse>> {

...
class EpisodeServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EpisodeServiceAsync = EpisodeServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: EpisodeCreateParams, requestOptions: RequestOptions): CompletableFuture<Episode> =
        // post /episodes
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: EpisodeRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Episode> =
        // get /episodes/{episode_id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: EpisodeUpdateParams, requestOptions: RequestOptions): CompletableFuture<Episode> =
        // patch /episodes/{episode_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: EpisodeListParams, requestOptions: RequestOptions): CompletableFuture<EpisodeListPageAsync> =
        // get /episodes
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: EpisodeDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // delete /episodes/{episode_id}
        withRawResponse().delete(params, requestOptions).thenAccept {}

    override fun getWisdom(params: EpisodeGetWisdomParams, requestOptions: RequestOptions): CompletableFuture<EpisodeGetWisdomResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EpisodeServiceAsync.WithRawResponse = EpisodeServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Episode> = jsonHandler<Episode>(clientOptions.jsonMapper)

        override fun create(params: EpisodeCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Episode>> {
        ...
        override fun retrieve(params: EpisodeRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Episode>> {
        ...
        override fun update(params: EpisodeUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Episode>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("episodeId", params.episodeId().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun list(params: EpisodeListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EpisodeListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("episodes")
        ...
        override fun delete(params: EpisodeDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("episodeId", params.episodeId().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun getWisdom(params: EpisodeGetWisdomParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<EpisodeGetWisdomResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("episodeId", params.episodeId().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)

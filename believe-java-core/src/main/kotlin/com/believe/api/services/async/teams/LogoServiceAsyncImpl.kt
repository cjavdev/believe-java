...
class LogoServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LogoServiceAsync = LogoServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun delete(params: LogoDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // delete /teams/{team_id}/logo/{file_id}
        withRawResponse().delete(params, requestOptions).thenAccept {}

    override fun download(params: LogoDownloadParams, requestOptions: RequestOptions): CompletableFuture<LogoDownloadResponse> =
        // get /teams/{team_id}/logo/{file_id}
        withRawResponse().download(params, requestOptions).thenApply { it.parse() }

    override fun upload(params: LogoUploadParams, requestOptions: RequestOptions): CompletableFuture<FileUpload> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LogoServiceAsync.WithRawResponse = LogoServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val deleteHandler: Handler<Void?> = emptyHandler()

        override fun delete(params: LogoDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun download(params: LogoDownloadParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<LogoDownloadResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("fileId", params.fileId().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun upload(params: LogoUploadParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<FileUpload>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.

...
class CommentaryServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CommentaryServiceAsync = CommentaryServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun stream(params: CommentaryStreamParams, requestOptions: RequestOptions): CompletableFuture<CommentaryStreamResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CommentaryServiceAsync.WithRawResponse = CommentaryServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val streamHandler: Handler<CommentaryStreamResponse> = jsonHandler<CommentaryStreamResponse>(clientOptions.jsonMapper)

        override fun stream(params: CommentaryStreamParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CommentaryStreamResponse>> {

...
interface CharacterService {
    ...
    fun create(params: CharacterCreateParams): Character =
        create(
    ...
    /** @see retrieve */
    fun retrieve(characterId: String, params: CharacterRetrieveParams = CharacterRetrieveParams.none()): Character =
        retrieve(
          characterId,
          params,
          RequestOptions.none(),
    ...
    fun update(characterId: String): Character =
        update(
    ...
    /** @see update */
    fun update(characterId: String, params: CharacterUpdateParams = CharacterUpdateParams.none()): Character =
        update(
          characterId,
          params,
          RequestOptions.none(),
    ...
    /** @see update */
    fun update(params: CharacterUpdateParams): Character =
        update(
          params, RequestOptions.none()
        )
    ...
    /** @see delete */
    fun delete(params: CharacterDeleteParams) =
        delete(
          params, RequestOptions.none()
        )
    ...
    /** @see getQuotes */
    fun getQuotes(characterId: String, params: CharacterGetQuotesParams = CharacterGetQuotesParams.none()): List<String> =
        getQuotes(
          characterId,
          params,
          RequestOptions.none(),
    ...
    interface WithRawResponse {
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(characterId: String, params: CharacterRetrieveParams = CharacterRetrieveParams.none()): HttpResponseFor<Character> =
            retrieve(
              characterId,
              params,
              RequestOptions.none(),
        ...
        /** @see update */
        @MustBeClosed
        fun update(characterId: String, params: CharacterUpdateParams = CharacterUpdateParams.none()): HttpResponseFor<Character> =
            update(
              characterId,
              params,
              RequestOptions.none(),
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: CharacterListParams = CharacterListParams.none()): HttpResponseFor<CharacterListPage> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(characterId: String, params: CharacterDeleteParams = CharacterDeleteParams.none()): HttpResponse =
            delete(
              characterId,
              params,
              RequestOptions.none(),
        ...
        /** @see getQuotes */
        @MustBeClosed
        fun getQuotes(characterId: String, params: CharacterGetQuotesParams = CharacterGetQuotesParams.none()): HttpResponseFor<List<String>> =
            getQuotes(
              characterId,
              params,
              RequestOptions.none(),

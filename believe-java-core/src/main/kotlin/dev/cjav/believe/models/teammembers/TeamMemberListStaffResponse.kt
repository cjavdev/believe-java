...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = teamMemberListStaffResponse.accept(new TeamMemberListStaffResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitMedicalStaff(MedicalStaff medicalStaff) {
     *         return Optional.of(medicalStaff.toString());
     *     }
     *
     *     // ...
     *

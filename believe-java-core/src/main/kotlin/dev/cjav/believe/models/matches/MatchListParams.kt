...
private constructor(
    ...
    fun matchType(): Optional<MatchType> = Optional.ofNullable(matchType)

    /** Filter by result */
    fun result(): Optional<MatchResult> = Optional.ofNullable(result)
    ...
    companion object {
        ...
        @JvmStatic fun none(): MatchListParams = builder().build()

...
class MedicalSpecialty @JsonCreator private constructor(private val value: JsonField<String>) :
    ...
    companion object {
        ...
        @JvmField val TEAM_DOCTOR = of("team_doctor")

        @JvmField val PHYSIOTHERAPIST = of("physiotherapist")

        @JvmField val SPORTS_PSYCHOLOGIST = of("sports_psychologist")

        @JvmField val NUTRITIONIST = of("nutritionist")

        @JvmField val MASSAGE_THERAPIST = of("massage_therapist")

        @JvmStatic fun of(value: String) = MedicalSpecialty(JsonField.of(value))
    }

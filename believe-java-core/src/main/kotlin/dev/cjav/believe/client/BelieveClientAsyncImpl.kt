...
import dev.cjav.believe.services.async.BelieveServiceAsyncImpl
import dev.cjav.believe.services.async.BiscuitServiceAsync
import dev.cjav.believe.services.async.BiscuitServiceAsyncImpl
import dev.cjav.believe.services.async.CharacterServiceAsync
import dev.cjav.believe.services.async.CharacterServiceAsyncImpl
import dev.cjav.believe.services.async.ClientServiceAsync
import dev.cjav.believe.services.async.ClientServiceAsyncImpl
import dev.cjav.believe.services.async.CoachingServiceAsync
import dev.cjav.believe.services.async.CoachingServiceAsyncImpl
import dev.cjav.believe.services.async.ConflictServiceAsync
import dev.cjav.believe.services.async.ConflictServiceAsyncImpl
import dev.cjav.believe.services.async.EpisodeServiceAsync
import dev.cjav.believe.services.async.EpisodeServiceAsyncImpl
import dev.cjav.believe.services.async.HealthServiceAsync
import dev.cjav.believe.services.async.HealthServiceAsyncImpl
import dev.cjav.believe.services.async.MatchServiceAsync
import dev.cjav.believe.services.async.MatchServiceAsyncImpl
import dev.cjav.believe.services.async.PepTalkServiceAsync
import dev.cjav.believe.services.async.PepTalkServiceAsyncImpl
import dev.cjav.believe.services.async.PressServiceAsync
import dev.cjav.believe.services.async.PressServiceAsyncImpl
import dev.cjav.believe.services.async.QuoteServiceAsync
import dev.cjav.believe.services.async.QuoteServiceAsyncImpl
import dev.cjav.believe.services.async.ReframeServiceAsync
import dev.cjav.believe.services.async.ReframeServiceAsyncImpl
import dev.cjav.believe.services.async.StreamServiceAsync
import dev.cjav.believe.services.async.StreamServiceAsyncImpl
import dev.cjav.believe.services.async.TeamMemberServiceAsync
import dev.cjav.believe.services.async.TeamMemberServiceAsyncImpl
import dev.cjav.believe.services.async.TeamServiceAsync
import dev.cjav.believe.services.async.TeamServiceAsyncImpl
import dev.cjav.believe.services.async.TicketSaleServiceAsync
import dev.cjav.believe.services.async.TicketSaleServiceAsyncImpl
import dev.cjav.believe.services.async.VersionServiceAsync
import dev.cjav.believe.services.async.VersionServiceAsyncImpl
import dev.cjav.believe.services.async.WebhookServiceAsync
import dev.cjav.believe.services.async.WebhookServiceAsyncImpl
...
class BelieveClientAsyncImpl(private val clientOptions: ClientOptions) : BelieveClientAsync {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BelieveClientAsync =
        BelieveClientAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun getWelcome(
        ...
        // get /
        withRawResponse().getWelcome(params, requestOptions).thenApply { it.parse() }

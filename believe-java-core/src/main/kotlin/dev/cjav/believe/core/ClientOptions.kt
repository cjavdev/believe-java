...
import dev.cjav.believe.core.http.LoggingHttpClient
import dev.cjav.believe.core.http.PhantomReachableClosingHttpClient
import dev.cjav.believe.core.http.QueryParams
import dev.cjav.believe.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `believe-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [dev.cjav.believe.core.jsonMapper]. The default is usually sufficient and rarely
    ...
    class Builder internal constructor() {
         ...
         * The Jackson JSON mapper to use for serializing and deserializing JSON.
         *
         * Defaults to [dev.cjav.believe.core.jsonMapper]. The default is usually sufficient and
                            ...
                            object : ThreadFactory {
                                ...
                                override fun newThread(runnable: Runnable): Thread =
                                    threadFactory.newThread(runnable).also {
                                        it.name =
                                            "believe-stream-handler-thread-${count.getAndIncrement()}"
                                    }
                            }
                        )
                    )

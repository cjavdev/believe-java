    ...
    publications {
        register<MavenPublication>("maven") {
            ...
            pom {
                ...
                url.set("https://www.github.com/stainless-sdks/believe-java")
                ...
                scm {
                    connection.set("scm:git:git://github.com/stainless-sdks/believe-java.git")
                    developerConnection.set("scm:git:git://github.com/stainless-sdks/believe-java.git")
                    url.set("https://github.com/stainless-sdks/believe-java")
                }
